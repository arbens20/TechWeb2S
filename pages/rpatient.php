...
<?php include("menu.php");?>
    ...
    <form action="rpatient.php" method="POST" class="select">
            <label for="search">La Liste Des patient</label> </br>
        </div>
        
        <input type="search" name="search" placeholder="Rechercher">
        <button type="submit" class="fas fa-search" name="search">Rechercher</button>
              <table class="table">
                <thead>
                  <tr>
                  <th id="th">code</th>
